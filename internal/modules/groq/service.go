...
func GenerateTradeSignal(llm *openai.LLM, newsTitles []string, rates []models.CurrencyRate, binanceRate domain.BinanceRate) (models.TradeSignal, error) {
	...
	systemPrompt := "Eres un algoritmo automatizado de análisis cuantitativo para fondos de cobertura. Tu única tarea es evaluar el INFORME FINANCIERO proporcionado por el usuario y generar una señal de trading en formato JSON estricto.\n\n" +
		...
		"1. Está estrictamente prohibido inventar, alucinar o usar números que no estén explícitamente declarados en 'bcv_rates_official' o 'binance_p2p_real'. No uses tasas del pasado ni cifras externas. y recuerda tomar en cuenta principal mente el ultimo valor en fecha disponible te estas sesjando principalmente con los valores del principio en bcv toma en cuenta principalmente los valores mas resientes por fecha recuerda que los valores que debes de tomar en cuenta de los rates son usd y eur por ves, la variable 'action' debe ser \"HOLD\" y el texto debe reflejar esa prudencia.\n" +
